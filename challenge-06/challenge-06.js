...
var times = ['Botafogo', 'Vasco', 'Flamengo', 'Fluminense', 'America'];
console.log("");
...
function showTeamPosition(posicao){
    if(times[posicao - 1] === undefined){
        return "Não temos a informação do time que está nessa posição.";
    }

    return "O time que está em " + posicao + "º lugar é o " + times[posicao - 1] + ".";
}
